...
lm1 = lm(pH~pH1+pH2,train)  # training 1st linear model
lm2 = lm(pH~feed1+feed3+pH1+pH2+pH3+pH5+pH6+DO1+DO2+DO4+DO6,train)  # training 2nd linear model
b1 = lm(pH~feed1+Temp1+Temp6+pH1+pH2+DO2+DO5,train)  # training 1st Bayesian model
b2 = lm(pH~feed1+Temp1+pH1+pH2+DO2+DO5,train)  # training 2nd Bayesian model
...
summary(lm1)  # get regression coefficients and se
...
lm2 = lm(pH~feed1+feed3+pH1+pH2+pH3+pH5+pH6+DO1+DO2+DO4+DO6,test)
b1 = lm(pH~feed1+Temp1+Temp6+pH1+pH2+DO2+DO5,test)
b2 = lm(pH~feed1+Temp1+pH1+pH2+DO2+DO5,test)
